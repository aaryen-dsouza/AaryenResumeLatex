...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
	      ...
	      \textbf{Data Manipulation \& Visualization}{: Pandas, NumPy, Matplotlib, Seaborn, Tableau, Power BI, PySpark, dbt} \\
...
\resumeItem{Designed and implemented \textbf{data models and dashboards in Power BI and SQL}, enabling 5+ university departments to access self-service insights on enrolment, retention, and performance metrics.}
