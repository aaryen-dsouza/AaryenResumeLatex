...
\section{Professional Experience}
  \resumeSubHeadingListStart
    ...
    \resumeExperienceSubheading
      ...
      \resumeItemListStart
        \resumeItem{Ensured data integrity by conducting data preprocessing and validations through \textbf{Oracle SQL} and \textbf{MS Excel}, solving 95\% of data quality issues, and providing detailed analysis reports for price plans, reimbursements and chargebacks.}\vspace{-11pt}\resumeItem{Reduced issue resolution time by 40\% for 100+ customer-reported issues by performing in-depth root cause analysis (RCA) on legacy app server and Oracle database, leading to faster issue identification and customer satisfaction.}
...
\resumeSubHeadingListStart
    \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed an interactive loan data analysis dashboard using \textbf{Power BI} and \textbf{SQL}, enabling real-time insights into financial metrics, borrower behavior, and loan performance.}
            \resumeItem{Enhanced data visualization and reporting by implementing dynamic \textbf{KPI} tracking, trend analysis, and loan classification, improving financial strategy planning.}
            \resumeItem{Optimized loan performance tracking by improving \textbf{data processing} and designing \textbf{interactive dashboards}, enabling better risk assessment and lending pattern identification.}
          \resumeItemListEnd
          \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed a stress prediction model for a mobile app by analyzing user behavior metrics, optimizing and training ML models on digital wellbeing data including screen time, gaming time, app usage, and social media activity.}
