...
\begin{itemize}[leftmargin=0in, label={}]
    \small{\item{
    Results-driven \textbf{Data Analyst \& Data Engineer} with \textbf{2+ years of experience} building scalable data models, automating ETL workflows, and delivering interactive dashboards using \textbf{SQL, Python, and Power BI}. Proven ability to process \textbf{100K+ record datasets}, improve data quality, and generate KPI-driven insights for strategic decision-making. Experienced in \textbf{Oracle SQL, DAX, and workflow automation} with a strong foundation in data engineering principles. Seeking a full-time data role where I can bridge analytics and engineering to drive business impact.
    }}
\end{itemize}
